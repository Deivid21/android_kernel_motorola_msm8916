...
/* this has changed for the latest compress framework but QCOM seem to be behind:
   temp take it out so things can compile
...
/* this has changed for the latest compress framework but QCOMM seem to be behind:
   temp take it out so things can compile
